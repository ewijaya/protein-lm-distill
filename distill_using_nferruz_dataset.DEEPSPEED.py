...
# This code DOES NOT WORK, use then non-deepspeed. It will still work with multiple GPU
# by making use of torch DataParallel
...
# Add this line to handle DeepSpeed's arguments
...
deepspeed_config = {
    ...
    "optimizer": {
        "type": "Adam",
        "params": {"lr": args.learning_rate, "weight_decay": 0.01, "eps": 1e-8},
    },
    "fp16": {"enabled": True},
...
trainer = DistillationTrainer(
    ...
    alpha=args.alpha,
    model=model_engine,  # Use the DeepSpeed model engine
    args=training_args,
