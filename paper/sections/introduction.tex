...
Beyond inference efficiency, a critical question for such applications is whether
distilled models can serve as effective starting points for domain-specific
fine-tuning on proprietary datasets---typically comprising only 50--1{,}000 sequences
from a target protein family.
