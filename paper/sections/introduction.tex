...
\emph{complementary regularization}: uncertainty weighting alone increases perplexity by 95\%
...
\begin{enumerate}
  ...
  \item Discovery and mechanistic explanation of complementary regularization, where
