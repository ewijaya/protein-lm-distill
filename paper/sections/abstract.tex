...
adaptation on scarce proprietary data. We distill a 738M-parameter protein language model into compact
...
at biologically variable positions. Students achieve up to 5$\times$ inference speedup, preserve natural amino
acid distributions, and require as little as 170\,MB of GPU memory, enabling
deployment on consumer-grade hardware. When
